/*
Runtime: 3 ms, faster than 85.17% of C++ online submissions for Search in Rotated Sorted Array.
Memory Usage: 11 MB, less than 95.98% of C++ online submissions for Search in Rotated Sorted Array.
...
is [nums[k], nums[k+1], ..., nums[n-1], nums[0], nums[1], ..., nums[k-1]] (0-indexed). For example, [0,1,2,4,5,6,7] might be rotated at pivot index 3 
